...
export function PwaNotice() {
  ...
  return (
    <aside
      aria-live="polite"
      className="safe-top absolute inset-x-4 top-0 z-50 rounded-card border border-shallows bg-surface p-4 shadow-float"
    >
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-0.5 text-sm font-medium text-ocean/60">
            {updateAvailable
          ...
          {updateAvailable ? (
            <div className="mt-3 flex gap-2">
              ...
              <button
                ...
                className="min-h-11 rounded-full border border-shallows px-4 text-sm font-bold text-ocean"
              >
                Later
              </button>
            </div>
        ...
        {!updateAvailable ? (
          <button
            ...
            className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full text-ocean/50"
          >

...
export const DEMO_DIVES = [
  [
    '2026-02-14',
    {
      ...
      depth: 21,
      minutes: 48,
      creatures: ['green-sea-turtle', 'queen-angelfish', 'stoplight-parrotfish', 'french-grunt'],
  ...
  [
    '2026-02-15',
    {
      ...
      depth: 27,
      minutes: 42,
      creatures: ['spotted-eagle-ray', 'great-barracuda', 'nurse-shark', 'french-angelfish', 'green-moray'],
  ...
  [
    '2026-02-16',
    {
      ...
      depth: 24,
      minutes: 45,
      creatures: ['caribbean-spiny-lobster', 'spotted-moray', 'queen-angelfish'],
  ...
  [
    '2026-02-17',
    {
      ...
      depth: 18,
      minutes: 51,
      creatures: ['green-sea-turtle', 'hawksbill-sea-turtle', 'stoplight-parrotfish'],
  ...
  [
    '2026-06-03',
    {
      ...
      depth: 16,
      minutes: 56,
      creatures: ['green-sea-turtle', 'southern-stingray', 'longsnout-seahorse', 'caribbean-reef-squid'],
  ...
  [
    '2026-09-01',
    {
      ...
      depth: 17,
      minutes: 49,
      creatures: ['user:Goliath grouper', 'nurse-shark', 'blue-tang', 'french-grunt', 'porcupinefish'],

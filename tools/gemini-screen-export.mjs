...
const sources = {
  ...
  creatureTile: ['12_CreatureTile.tsx', 'apps/web/src/components/CreatureTile.tsx'],
  creatureImage: ['13_CreatureImage.tsx', 'apps/web/src/components/CreatureImage.tsx'],
  ...
  logSteps: ['32_log-dive-steps.tsx', 'apps/web/src/features/log-dive/steps.tsx'],
  logController: [
  ...
  creatureDetail: ['51_CreatureDetail.tsx', 'apps/web/src/screens/CreatureDetail.tsx'],

  dataBackup: ['60_DataAndBackup.tsx', 'apps/web/src/screens/DataAndBackup.tsx'],
...
const packs = {
  ...
  plan: ['product', 'app', 'css', 'shell', 'ui', 'home', 'journal', 'atlas', 'collection'],
...
This folder is a disposable, flat handoff for Gemini. It is **not** a runnable copy of Poseidon and it is **not** source authority. Never integrate changes by replacing the repo with this folder; map any accepted edits back to the original paths below and review them in the real app.
...
`;
  ...
  console.log(`Gemini export ready: gemini-export/ (${keys.length + 1} files, pack: ${requestedPack})`);
